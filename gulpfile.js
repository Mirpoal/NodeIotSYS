...
var vendorSrcJS = [
    ...
    './src/admin/vendor/echarts-2.0/echarts.js'
];
 ...
 * 默认模式编译
 */
gulp.task('default', ['build-admin-assets-less','concat-admin-views', 'copy-admin-assets','concat-vendor-js-less','concat-admin-js-less','concat-vendor-css-less','copy-admin-font-awersome-fonts']);
